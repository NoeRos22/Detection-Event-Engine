...
config_path = "../covenant/data/config_tests.yaml"
...
def test_multiclass():
    ...
    engine.process({"timestamp_ms": 1000, "camera_id": "c1", "class": "person", "confidence": 0.9})
    
    # First detection class car
    engine.process({"timestamp_ms": 1100, "camera_id": "c1", "class": "car", "confidence": 0.8})
    
    # Second detection class person
    engine.process({"timestamp_ms": 1500, "camera_id": "c1", "class": "person", "confidence": 0.9})
    
    # Third detection class person 
    events = engine.process({"timestamp_ms": 2000, "camera_id": "c1", "class": "person", "confidence": 0.9})
    ...
    events = engine.process({"timestamp_ms": 1600, "camera_id": "c1", "class": "car", "confidence": 0.8})

    # Third detection class car 
    events = engine.process({"timestamp_ms": 2100, "camera_id": "c1", "class": "car", "confidence": 0.85})
...
def test_multicam():
    ...
    # First detection class car
    engine.process({"timestamp_ms": 1100, "camera_id": "c2", "class": "person", "confidence": 0.8})
    ...
    # Second detection class car
    events = engine.process({"timestamp_ms": 1600, "camera_id": "c2", "class": "person", "confidence": 0.8})

    # Third detection class car 
    events = engine.process({"timestamp_ms": 2100, "camera_id": "c2", "class": "person", "confidence": 0.85})
...
def test_flush():
    ...
    # Cam 1 person opened
    engine.process({"timestamp_ms": 1000, "camera_id": "c1", "class": "person", "confidence": 0.9})
    engine.process({"timestamp_ms": 1500, "camera_id": "c1", "class": "person", "confidence": 0.8})
    engine.process({"timestamp_ms": 2000, "camera_id": "c1", "class": "person", "confidence": 0.9})

    # Cam 1 person opened
    engine.process({"timestamp_ms": 1000, "camera_id": "c1", "class": "car", "confidence": 0.9})
    engine.process({"timestamp_ms": 1500, "camera_id": "c1", "class": "car", "confidence": 0.8})
    engine.process({"timestamp_ms": 2000, "camera_id": "c1", "class": "car", "confidence": 0.9})

    # Cam 2 person opened
    engine.process({"timestamp_ms": 1000, "camera_id": "c2", "class": "person", "confidence": 0.9})
    engine.process({"timestamp_ms": 1500, "camera_id": "c2", "class": "person", "confidence": 0.8})
    engine.process({"timestamp_ms": 2000, "camera_id": "c2", "class": "person", "confidence": 0.9})
